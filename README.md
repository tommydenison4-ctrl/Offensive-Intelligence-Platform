...
## v63 Southeastern Louisiana
- Added Southeastern Louisiana as a third opponent without changing Mississippi State or UAB.
- Supabase auto-detects Current/Southeastern Louisiana and common alternate folder layouts.
- SELA sources: play_feed (23), overall defense 50, tackling 54, pass rush 60, run defense 61, coverage 62.
- Loads SELA roster.json and depth-chart.json from the selected opponent folder.
- Player Intelligence supports 2025/2026 toggle; current-player leaders only.
- Main analytics support 2025 Raw / 2026 Raw / true 50-50 weighted math with no duplicated plays.


## v64 Southeastern rosters + depth chart
- Added official 2026 Southeastern defensive roster fallback from lionsports.net.
- Added official 2025 historical defensive roster fallback from lionsports.net.
- Added Southeastern defensive depth chart from the Command Center Week 3 depth chart.
- Fixed Southeastern Depth Chart page so it no longer falls back to Mississippi State.
